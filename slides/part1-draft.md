...
# 2023: 출발점 — 똑똑한 후배의 첫 출근

**아는 것은 많다. 하지만 우리 일은 아무것도 모른다.**

- 🔒 **갇힌 지식** — 세상 지식은 많지만, 우리 도메인·우리 코드·최신 정보를 모름
- 📋 **복붙 워크플로우** — 모든 맥락을 매번 구두로 전달하고, 결과도 받아 적어야 함
- ❓ **환각** — 모르는 것도 그럴듯하게, 자신 있게 말함
...
**Part 2로 넘어가기 전에 — 두 가지 안전 수칙 (Introduction ②의 "업무의 검증·권한 제한")**
