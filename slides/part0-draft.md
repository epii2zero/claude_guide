...
# AI는 이미 수학의 난제를 풀기 시작했다

**2026년 7월, 2주 사이에 일어난 일**

🔹 **야코비안 추측 (1939, 87년 미해결) — 반증**
수학자 알포게 + **Claude Fable 5**가 반례를 발견
→ 손으로 검증 가능, 하루 만에 Lean 기계 검증, Terence Tao가 해설·정리

🔹 **사이클 이중 덮개 추측 (~50년 미해결) — 증명 발표**
OpenAI **GPT-5.6**이 증명 제시 → 수학자들 "우아한 증명" (동료 검토 진행 중)

그리고: IMO 금메달 수준 (2025) · 에르되시 미해결 문제들 해결 (2026.01, Tao 검증)

<!--
#0.2 | 2분 | 훅
- 두 소식을 뉴스 헤드라인처럼. 청중이 아직 모를 수 있는 최신 소식이라 임팩트 큼.
